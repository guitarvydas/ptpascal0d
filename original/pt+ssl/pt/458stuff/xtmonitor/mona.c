/* XT VAX/SUN Runtime Monitor (Part A)  Ver. 1.02,
   after PT VAX/SUN Runtime Monitor Ver. 1.02,
   after PT PDP-11 Runtime Monitor  Ver. 1.01

   Author:  J.A. Rosselet, University of Toronto
	    VAX/SUN conversion by J.R. Cordy, Queen's University at Kingston

   Date 30 Jun 1980
	 (Updated 12 Feb 1981)
	 (VAX/SUN conversion 30 Aug 1985)
...
/* XT String Routines - note that these do not give error messages
...
XTWriteString (s, fileOffset, fieldWidth)
    char  s[];
    int   fieldWidth, fileOffset;
    {
	register int i;
